...
def tabular_q_learning(q_func, current_state_1, current_state_2, action_index,
    ...
    # TODO Your code here
    if not terminal:
        v_s = GAMMA*q_func[next_state_1, next_state_2].max()
        value = (1-ALPHA)*q_func[current_state_1, current_state_2, action_index, object_index] + ALPHA*(reward + v_s)
        q_func[current_state_1, current_state_2, action_index,
               object_index] = value  # TODO Your update here
    else:
        value = (1-ALPHA)*q_func[current_state_1, current_state_2, action_index, object_index] + ALPHA*(reward)
        q_func[current_state_1, current_state_2, action_index,
               object_index] = value
...
def run_episode(for_training):
    ...
    while not terminal:
        ...
        if for_training:
            ...
            q_func[state_1,state_2,action_index,object_index] = tabular_q_learning(q_func,state_1,state_2, \
                                                                                    action_index, object_index,
